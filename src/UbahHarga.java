...
public class UbahHarga extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hapusTransaksiBtn = new javax.swing.JButton();
        ...
        hapusTransaksiBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        hapusTransaksiBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Trash.png"))); // NOI18N
        hapusTransaksiBtn.setAlignmentY(0.0F);
        hapusTransaksiBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                hapusTransaksiBtnMouseClicked(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(prosesUbahBarangBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(hapusTransaksiBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(hapusTransaksiBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void hapusTransaksiBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_hapusTransaksiBtnMouseClicked
        try {
            ubahHargaJual ubh = new ubahHargaJual ();
            ...
            if(!ubh.nama_barang.isEmpty() && ubh.tanggal_ubah != null && 
                ...
                if (selectedRow != -1) {
                    Object tanggal_ubah = model.getValueAt(selectedRow, 1);
                    ...
                    double hargaJualLama = Double.parseDouble(hargaLama.toString());
                    double hargaJualBaru = Double.parseDouble(hargaBaru.toString());

                    int dialogBtn = JOptionPane.YES_NO_OPTION;
                    int confirmDelete = JOptionPane.showConfirmDialog(null, "Apakah Anda yakin ingin menghapus transaksi tersebut?", "Warning", dialogBtn);

                    if(confirmDelete == JOptionPane.YES_OPTION) {
                        this.stt = conn.getConnection().prepareStatement("SELECT barang_id, nama_barang FROM barang");
                        this.rs = this.stt.executeQuery();
                        
                        while(rs.next()) {
                            if(ubh.nama_barang.equals(this.rs.getString("nama_barang"))) {
                                ubh.barang_id = rs.getInt("barang_id");
                                break;
                            }
                        }
                        
                        this.sta = conn.getConnection().prepareStatement("SELECT * FROM revisihargajual");
                        this.rt = this.sta.executeQuery();
                        
                        while(rt.next()) {
                            if(hargaJualLama == rt.getDouble("harga_jual_lama") 
                               && hargaJualBaru == rt.getDouble("harga_jual_baru")
                               && ubh.barang_id == rt.getInt("barang_id")) {
                                ubh.revisihargajual_id = rt.getInt("revisihargajual_id");
                            }
                        }

                        String hapusRevisiHarga = "DELETE FROM revisihargajual WHERE revisihargajual_id = ?";
                        this.sth = conn.getConnection().prepareStatement(hapusRevisiHarga);
                        this.sth.setInt(1, ubh.revisihargajual_id);
    ...
    }//GEN-LAST:event_hapusTransaksiBtnMouseClicked
    ...
    private javax.swing.JButton hapusTransaksiBtn;
